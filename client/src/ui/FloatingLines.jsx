...
const DEFAULT_OPTIONS = {
  ...
  colors: {
    ...
    // Purple, Violet, DarkViolet for Left Cars
    leftCars: [0x800080, 0xEE82EE, 0x9400D3],
    // DarkBlue, Indigo, BlueViolet for Right Cars
    rightCars: [0x00008B, 0x4B0082, 0x8A2BE2],
    // Violet for sticks
    sticks: 0xEE82EE
  }
};
  ...
  constructor(container, options = {}) {
    ...
    if (this.options.distortion == null) {
      this.options.distortion = {
        uniforms: distortion_uniforms_def,
...
const Hyperspeed = memo(({
  ...
  useEffect(() => {
    ...
    // Resolve distortion object from string key or use default
  ...
  return <div id={id} className={`w-full h-full ${className}`} style={style} ref={containerRef}></div>;
});
