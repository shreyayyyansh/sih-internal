...
import { ArrowLeft, MapPin, MapPinned, Gift, Shirt, BookOpen, Pill, Laptop, Package } from "lucide-react";
...
export default function ReceiverCategory() {
  ...
  const handleCategoryClick = (category) => {
    ...
    navigate(`/kindshare/receiver/ngos?category=${encodeURIComponent(category)}&lat=${lat}&lon=${lon}`);
  };
  ...
  return (
    <div style={PAGE}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "28px", alignItems: "start" }}>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
            <div style={{ width: "42px", height: "42px", borderRadius: "12px", backgroundColor: "rgba(96,165,250,0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}><Gift size={20} color="#60a5fa" /></div>
            <div>
              <h2 style={{ fontSize: "18px", fontWeight: "800", color: "#fff", margin: 0 }}>Browse Category</h2>
              <p style={{ color: "#71717a", fontSize: "12px", margin: "2px 0 0 0" }}>Select what you'd like to receive</p>
            </div>
          </div>
